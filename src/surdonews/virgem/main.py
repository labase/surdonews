# -*- coding: utf-8 -*-
# brincando com imagens fazendo labirinto - em 24 de setembro
from browser import document, html

STYLE = dict(position="absolute", width=300, left=0, top=0, background="white")
ISTYLE = dict(opacity="inherited", height=30, left=0, top=0, background="white")
...
class Folha:
    def __init__(self, texto, html, tela, left):
        style = dict(position="absolute", width=80, height=80, left=left, top=10, background="yellow")
        fid = "folha%d" % left
...
class Suporte:
    def __init__(self, bloco, html, tela, left, certa):
        style = dict(position="absolute", width=80, height=80, left=left, top=100, background="grey")
